...
const ManualDiscountModal: React.FC<ManualDiscountModalProps> = ({ currentDiscount, onClose, onApply, storeSettings }) => {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex gap-4">
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                />
                                <span className="text-slate-700 dark:text-slate-200">Fixed Amount ({storeSettings.currency.symbol})</span>
                            </label>
                             <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    type="radio"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            />
                            <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400">{type === 'fixed' ? storeSettings.currency.symbol : '%'}</span>
                        </div>
                    </div>
